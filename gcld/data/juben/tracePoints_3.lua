...
function jubenTracePoints.elapse_2_5()
    local data = {}
    data.count = 8
    data.time = {}
    data.time[1] = 0.113
...
function jubenTracePoints.elapse_5_3()
    local data = {}
    data.count = 9
    data.time = {}
    data.time[1] = 0.094
...
function jubenTracePoints.elapse_3_9()
    local data = {}
    data.count = 12
    data.time = {}
    data.time[1] = 0.078
...
function jubenTracePoints.elapse_4_9()
    local data = {}
    data.count = 10
    data.time = {}
    data.time[1] = 0.144
...
function jubenTracePoints.elapse_7_13()
    local data = {}
    data.count = 12
    data.time = {}
    data.time[1] = 0.057
...
function jubenTracePoints.elapse_8_13()
    local data = {}
    data.count = 11
    data.time = {}
    data.time[1] = 0.059
...
function jubenTracePoints.elapse_13_11()
    local data = {}
    data.count = 11
    data.time = {}
    data.time[1] = 0.041
