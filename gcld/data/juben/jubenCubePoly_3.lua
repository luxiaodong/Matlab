...
function jubenCubePoly.curve_2_5()
    local data = {}
    data.rank = 3
    data.x = {}
    data.y = {}
...
function jubenCubePoly.curve_5_3()
    local data = {}
    data.rank = 3
    data.x = {}
    data.y = {}
...
function jubenCubePoly.curve_7_13()
    local data = {}
    data.rank = 3
    data.x = {}
    data.y = {}
...
function jubenCubePoly.curve_8_13()
    local data = {}
    data.rank = 3
    data.x = {}
    data.y = {}
...
function jubenCubePoly.curve_13_11()
    local data = {}
    data.rank = 3
    data.x = {}
    data.y = {}
