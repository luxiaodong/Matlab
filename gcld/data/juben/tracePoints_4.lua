...
function jubenTracePoints.elapse_51_52()
    local data = {}
    data.count = 11
    data.time = {}
    data.time[1] = 0.056
...
function jubenTracePoints.elapse_52_53()
    local data = {}
    data.count = 9
    data.time = {}
    data.time[1] = 0.1
...
function jubenTracePoints.elapse_53_54()
    local data = {}
    data.count = 7
    data.time = {}
    data.time[1] = 0.104
...
function jubenTracePoints.elapse_54_55()
    local data = {}
    data.count = 7
    data.time = {}
    data.time[1] = 0.121
